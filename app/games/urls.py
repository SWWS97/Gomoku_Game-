...
urlpatterns = [
    ...
    path("ai/", views.ai_game, name="ai_game"),  # AI 대전
    path("ai/status/", views.ai_game_status, name="ai_game_status"),  # AI 대전 상태
    path("ai/leave/", views.ai_game_leave, name="ai_game_leave"),  # AI 대전 종료
